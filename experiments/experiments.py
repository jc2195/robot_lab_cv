...
left_hole = img_bottom_casing[470:570, 420:520]
left_hole = cv2.equalizeHist(left_hole)
ret, left_hole_binary = cv2.threshold(left_hole,20,255,cv2.THRESH_BINARY)
...
right_hole = img_bottom_casing[470:600, 600:730]
right_hole = cv2.equalizeHist(right_hole)
ret, right_hole_binary = cv2.threshold(right_hole,20,255,cv2.THRESH_BINARY)
